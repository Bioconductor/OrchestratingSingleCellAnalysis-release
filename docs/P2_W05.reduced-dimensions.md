...
<div class="figure">
<img src="P2_W05.reduced-dimensions_files/figure-html/elbow-1.svg" alt="Percentage of variance explained by successive PCs in the Zeisel brain data. The identified elbow point is marked with a red line." width="672" />
...
<div class="figure">
<img src="P2_W05.reduced-dimensions_files/figure-html/cluster-pc-choice-1.svg" alt="Number of clusters detected in the Zeisel brain dataset as a function of the number of PCs. The red unbroken line represents the theoretical upper constraint on the number of clusters, while the grey dashed line is the number of PCs suggested by `getClusteredPCs()`." width="672" />
...
<div class="figure">
<img src="P2_W05.reduced-dimensions_files/figure-html/zeisel-pca-1.svg" alt="PCA plot of the first two PCs in the Zeisel brain data. Each point is a cell, coloured according to the annotation provided by the original authors." width="672" />
...
<div class="figure">
<img src="P2_W05.reduced-dimensions_files/figure-html/zeisel-pca-multi-1.svg" alt="PCA plot of the first two PCs in the Zeisel brain data. Each point is a cell, coloured according to the annotation provided by the original authors." width="672" />
...
<div class="figure">
<img src="P2_W05.reduced-dimensions_files/figure-html/tsne-brain-1.svg" alt="$t$-SNE plots constructed from the top PCs in the Zeisel brain dataset. Each point represents a cell, coloured according to the published annotation." width="672" />
...
<div class="figure">
<img src="P2_W05.reduced-dimensions_files/figure-html/tsne-perplexity-1.svg" alt="$t$-SNE plots constructed from the top PCs in the Zeisel brain dataset, using a range of perplexity values. Each point represents a cell, coloured according to its annotation." width="1440" />
...
<div class="figure">
<img src="P2_W05.reduced-dimensions_files/figure-html/umap-brain-1.svg" alt="UMAP plots constructed from the top PCs in the Zeisel brain dataset. Each point represents a cell, coloured according to the published annotation." width="672" />
