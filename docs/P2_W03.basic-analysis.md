...
<div class="figure">
<img src="P2_W03.basic-analysis_files/figure-html/unnamed-chunk-16-1.png" alt="Mean-variance trend line fit by scran package trendVar() function." width="672" />
...
<div class="figure">
<img src="P2_W03.basic-analysis_files/figure-html/unnamed-chunk-24-1.png" alt="UMAP plot." width="672" />
...
<div class="figure">
<img src="P2_W03.basic-analysis_files/figure-html/unnamed-chunk-28-1.png" alt="UMAP plot showing calculated clusters." width="672" />
...
<div class="figure">
<img src="P2_W03.basic-analysis_files/figure-html/unnamed-chunk-33-1.png" alt="Heatmap showing top differentially expressed genes across the clusters." width="672" />
...
<div class="figure">
<img src="P2_W03.basic-analysis_files/figure-html/unnamed-chunk-34-1.png" alt="Various UMAP plots showing the expression of select cell-type specific genes." width="672" />
...
<div class="figure">
<img src="P2_W03.basic-analysis_files/figure-html/unnamed-chunk-34-2.png" alt="Various UMAP plots showing the expression of select cell-type specific genes." width="672" />
...
<div class="figure">
<img src="P2_W03.basic-analysis_files/figure-html/unnamed-chunk-34-3.png" alt="Various UMAP plots showing the expression of select cell-type specific genes." width="672" />
...
<div class="figure">
<img src="P2_W03.basic-analysis_files/figure-html/unnamed-chunk-34-4.png" alt="Various UMAP plots showing the expression of select cell-type specific genes." width="672" />
...
other attached packages:
 [1] scran_1.13.13               scater_1.13.17             
 [3] ggplot2_3.2.1               DropletUtils_1.5.7         
 [5] TENxPBMCData_1.3.0          HDF5Array_1.13.5           
 [7] rhdf5_2.29.0                SingleCellExperiment_1.7.7 
...
loaded via a namespace (and not attached):
 ...
 [7] AnnotationDbi_1.47.1          RSpectra_0.15-0              
 [9] R.methodsS3_1.7.1             knitr_1.24                   
[11] zeallot_0.1.0                 dbplyr_1.4.2                 
[13] R.oo_1.22.0                   pheatmap_1.0.12              
[15] uwot_0.1.3                    shiny_1.3.2                  
[17] BiocManager_1.30.4            compiler_3.6.1               
[19] httr_1.4.1                    dqrng_0.2.1                  
[21] backports_1.1.4               assertthat_0.2.1             
[23] Matrix_1.2-17                 lazyeval_0.2.2               
[25] limma_3.41.15                 later_0.8.0                  
[27] BiocSingular_1.1.5            htmltools_0.3.6              
...
[39] ExperimentHub_1.11.4          DelayedMatrixStats_1.7.1     
[41] xfun_0.9                      stringr_1.4.0                
[43] beachmat_2.1.2                mime_0.7                     
[45] irlba_2.3.3                   statmod_1.4.32               
[47] AnnotationHub_2.17.7          edgeR_3.27.12                
[49] zlibbioc_1.31.0               scales_1.0.0                 
[51] promises_1.0.1                RColorBrewer_1.1-2           
[53] yaml_2.2.0                    curl_4.0                     
[55] memoise_1.1.0                 gridExtra_2.3                
[57] stringi_1.4.3                 RSQLite_2.1.2                
[59] highr_0.8                     rlang_0.4.0                  
[61] pkgconfig_2.0.2               bitops_1.0-6                 
[63] evaluate_0.14                 lattice_0.20-38              
[65] purrr_0.3.2                   Rhdf5lib_1.7.4               
...
[81] BiocFileCache_1.9.1           rmarkdown_1.13               
[83] viridis_0.5.1                 locfit_1.5-9.1               
[85] grid_3.6.1                    blob_1.2.0                   
[87] FNN_1.1.3                     digest_0.6.20                
[89] xtable_1.8-4                  httpuv_1.5.1                 
[91] R.utils_2.9.0                 RcppParallel_4.4.3           
