...
\hypersetup{unicode=true,
            ...
            pdfauthor={Robert A. Amezquita; Stephanie C. Hicks; Bioconductor},
            pdfborder={0 0 0},
            breaklinks=true}
...
\KeywordTok{colData}\NormalTok{(sce)}\OperatorTok{$}\NormalTok{rsec_consensus_clusters <-}\StringTok{ }\KeywordTok{as.factor}\NormalTok{(}\KeywordTok{clusterMatrix}\NormalTok{(rsec)[, }\StringTok{"mergeClusters"}\NormalTok{])}
\end{Highlighting}
\end{Shaded}
