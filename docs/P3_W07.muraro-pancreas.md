...
<div class="figure">
<img src="P3_W07.muraro-pancreas_files/figure-html/unref-muraro-qc-dist-1.svg" alt="Distribution of each QC metric across cells from each donor in the Muraro pancreas dataset. Each point represents a cell and is colored according to whether that cell was discarded." width="672" />
...
<div class="figure">
<img src="P3_W07.muraro-pancreas_files/figure-html/unref-muraro-norm-1.svg" alt="Relationship between the library size factors and the deconvolution size factors in the Muraro pancreas dataset." width="672" />
...
<div class="figure">
<img src="P3_W07.muraro-pancreas_files/figure-html/unref-muraro-variance-1.svg" alt="Per-gene variance as a function of the mean for the log-expression values in the Muraro pancreas dataset. Each point represents a gene (black) with the mean-variance trend (blue) fitted to the spike-in transcripts (red) separately for each donor." width="672" />
...
<div class="figure">
<img src="P3_W07.muraro-pancreas_files/figure-html/unref-seger-heat-1.svg" alt="Heatmap of the frequency of cells from each cell type label in each cluster." width="672" />
...
<div class="figure">
<img src="P3_W07.muraro-pancreas_files/figure-html/unref-muraro-tsne-1.svg" alt="Obligatory $t$-SNE plots of the Muraro pancreas dataset. Each point represents a cell that is colored by cluster (left) or batch (right)." width="672" />
