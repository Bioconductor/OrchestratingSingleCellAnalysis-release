...
<div class="figure">
<img src="P2_W12.cell-cycle_files/figure-html/heat-cyclin-1.svg" alt="Heatmap of the log-normalized expression values of the cyclin genes in the 416B dataset." width="672" />
...
<div class="figure">
<img src="P2_W12.cell-cycle_files/figure-html/dist-lef1-1.svg" alt="Distribution of log-normalized expression values for _Lef1_ in the reference dataset (left) and in the 416B dataset (right)." width="672" />
...
<div class="figure">
<img src="P2_W12.cell-cycle_files/figure-html/phaseplot416b-1.svg" alt="Cell cycle phase scores from applying the pair-based classifier on the 416B dataset. Each point represents a cell, plotted according to its scores for G1 and G2/M phases." width="672" />
