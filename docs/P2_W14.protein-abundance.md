...
<div class="figure">
<img src="P2_W14.protein-abundance_files/figure-html/detected-ab-hist-1.svg" alt="Distribution of the number of detected ADTs across all cells in the PBMC dataset. The red dotted line indicates the threshold below which cells were removed." width="672" />
...
This is loosely based on a similar approach for normalization of ChIP-seq data based on background enrichment [@lun2016csaw].
    ...
    <div class="figure">
    <img src="P2_W14.protein-abundance_files/figure-html/comp-bias-norm-1.svg" alt="DESeq-like size factors for each cell in the PBMC dataset, compared to ADT library size factors. Each point is a cell and is colored according to the cluster identity defined from normalized ADT data." width="672" />
...
We demonstrate this approach below by computing size factors from the immunoglobulin (IgG) controls (Figure \@ref(fig:control-bias-norm)).
    ...
    <div class="figure">
    <img src="P2_W14.protein-abundance_files/figure-html/control-bias-norm-1.svg" alt="IgG control-derived size factors for each cell in the PBMC dataset, compared to the DESeq-like size factors." width="672" />
...
<div class="figure">
<img src="P2_W14.protein-abundance_files/figure-html/tsne-tags-1.svg" alt="$t$-SNE plot generated from the log-normalized abundance of each ADT in the PBMC dataset. Each point is a cell and is labelled according to its assigned cluster." width="672" />
...
<div class="figure">
<img src="P2_W14.protein-abundance_files/figure-html/heat-tags-1.svg" alt="Heatmap of the average log-normalized abundance of each ADT in each cluster of the PBMC dataset. Colors represent the log~2~-fold change from the grand average across all clusters." width="672" />
...
<div class="figure">
<img src="P2_W14.protein-abundance_files/figure-html/subcluster-stats-1.svg" alt="Number of subclusters identified from the gene expression data within each ADT-derived parent cluster." width="672" />
...
<div class="figure">
<img src="P2_W14.protein-abundance_files/figure-html/gzmh-cd8-t-1.svg" alt="Distribution of log-normalized expression values of _GZMH_ (left) and _GZHK_ (right) in transcript-derived subclusters of a ADT-derived subpopulation of CD8^+^ T cells." width="672" />
...
<div class="figure">
<img src="P2_W14.protein-abundance_files/figure-html/subcluster-tag-dist-1.svg" alt="Distribution of log-normalized abundances of ADTs for CD3 and CD8a in each subcluster of the CD8^+^ T cell population." width="672" />
...
<div class="figure">
<img src="P2_W14.protein-abundance_files/figure-html/combined-umap-1.svg" alt="UMAP plot obtained by combining transcript and ADT data in the PBMC dataset. Each point represents a cell and is colored according to its assigned cluster." width="672" />
...
<div class="figure">
<img src="P2_W14.protein-abundance_files/figure-html/tsne-naive-1.svg" alt="$t$-SNE plot of the PBMC dataset based on the transcript data. Each point is a cell and is colored according to the assigned cluster." width="672" />
...
<div class="figure">
<img src="P2_W14.protein-abundance_files/figure-html/heat-pd-1-1.svg" alt="Heatmap of log-fold changes in tag abundances in cluster 16 compared to all other clusters identified from transcript data in the PBMC data set." width="672" />
...
[19] dbplyr_1.4.2                BiocStyle_2.15.3            OSCAUtils_0.0.1            
...
[33] XVector_0.27.0         pkgconfig_2.0.3        htmltools_0.4.0        limma_3.43.0          
[37] highr_0.8              rlang_0.4.2            RSQLite_2.2.0          farver_2.0.1          
