...
For example, the `clusterSNNGraph()` function from *[scran](https://bioconductor.org/packages/3.11/scran)* can use $k$-means as an initial step to obtain representative centroids that are then subjected to graph-based clustering (Figure \@ref(fig:tsne-kmeans-graph-pbmc)).
...
[10] dqrng_0.2.1              GenomeInfoDbData_1.2.3   vipor_0.4.5             
[13] yaml_2.2.1               pillar_1.4.3             lattice_0.20-41         
[16] glue_1.4.0               limma_3.43.8             digest_0.6.25           
[19] RColorBrewer_1.1-2       XVector_0.27.2           colorspace_1.4-1        
[22] cowplot_1.0.0            htmltools_0.4.0          Matrix_1.2-18           
[25] pkgconfig_2.0.3          bookdown_0.18            zlibbioc_1.33.1         
[28] purrr_0.3.4              scales_1.1.0             processx_3.4.2          
[31] BiocParallel_1.21.3      tibble_3.0.1             farver_2.0.3            
[34] ellipsis_0.3.0           withr_2.2.0              magrittr_1.5            
[37] crayon_1.3.4             evaluate_0.14            ps_1.3.2                
[40] beeswarm_0.2.3           tools_4.0.0              lifecycle_0.2.0         
[43] stringr_1.4.0            munsell_0.5.0            locfit_1.5-9.4          
[46] irlba_2.3.3              callr_3.4.3              compiler_4.0.0          
[49] rsvd_1.0.3               rlang_0.4.5              grid_4.0.0              
[52] RCurl_1.98-1.2           BiocNeighbors_1.5.7      igraph_1.2.5            
[55] labeling_0.3             bitops_1.0-6             rmarkdown_2.1           
[58] gtable_0.3.0             codetools_0.2-16         R6_2.4.1                
