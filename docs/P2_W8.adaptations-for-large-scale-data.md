...
## 1 runPCA(tiny_sce, BSPARAM = IrlbaParam())    168ms    168ms        0B
## 2 runPCA(tiny_sce, BSPARAM = ExactParam())    828ms    828ms        0B
```
...
## 1 buildSNNGraph(tiny_sce_pca, BNPARAM = AnnoyParam())   771ms   771ms
## 2 buildSNNGraph(tiny_sce_pca, BNPARAM = KmknnParam())   1.38s   1.38s
...
## 1 buildSNNGraph(big_sce, BNPARAM = AnnoyParam())    7.59s   7.59s        0B
## 2 buildSNNGraph(big_sce, BNPARAM = KmknnParam())   12.84s  12.84s        0B
```
...
## 1 runUMAP(tiny_sce_pca, BPPARAM = SerialParam())     4.41s  4.41s        0B
## 2 runUMAP(tiny_sce_pca, BPPARAM = MulticoreParam())  4.27s  4.27s        0B
```
