...
## 1 runPCA(tiny_sce, BSPARAM = IrlbaParam())   42.1ms   43.3ms        0B
## 2 runPCA(tiny_sce, BSPARAM = ExactParam())  672.2ms  672.2ms        0B
```
...
## 1 buildSNNGraph(tiny_sce_pca, BNPARAM = AnnoyParam())    1.12s    1.12s
## 2 buildSNNGraph(tiny_sce_pca, BNPARAM = KmknnParam()) 608.14ms 608.14ms
...
## 1 buildSNNGraph(big_sce, BNPARAM = AnnoyParam())    5.95s   5.95s        0B
## 2 buildSNNGraph(big_sce, BNPARAM = KmknnParam())   11.77s  11.77s        0B
```
...
## 1 runUMAP(tiny_sce_pca, BPPARAM = SerialParam())     3.62s  3.62s        0B
## 2 runUMAP(tiny_sce_pca, BPPARAM = MulticoreParam())  3.81s  3.81s        0B
```
