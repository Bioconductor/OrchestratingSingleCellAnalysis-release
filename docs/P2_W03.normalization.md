...
<div class="figure">
<img src="P2_W03.normalization_files/figure-html/normplotspikemef-1.png" alt="Size factors from spike-in normalization, plotted against the library size factors for all cells in the mESC/MEF dataset. Each point is a cells, coloured according to its type." width="672" />
...
Once we have computed the size factors, we use the `logNormCouts()` function from *[scater](https://bioconductor.org/packages/3.10/scater)* to compute normalized expression values for each cell.
...
other attached packages:
 ...
 [3] scran_1.13.18               scater_1.13.18             
 [5] ggplot2_3.2.1               scRNAseq_1.99.3            
 [7] SingleCellExperiment_1.7.8  SummarizedExperiment_1.15.9
...
[15] IRanges_2.19.14             S4Vectors_0.23.21          
[17] BiocGenerics_0.31.5         Cairo_1.5-10               
...
[23] digest_0.6.20                 rmarkdown_1.15               
[25] XVector_0.25.0                pkgconfig_2.0.2              
[27] htmltools_0.3.6               limma_3.41.16                
...
[43] viridis_0.5.1                 edgeR_3.27.13                
[45] stringi_1.4.3                 yaml_2.2.0                   
[47] zlibbioc_1.31.0               AnnotationHub_2.17.9         
