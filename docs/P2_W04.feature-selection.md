...
other attached packages:
 [1] scater_1.15.33              ggplot2_3.3.0              
 [3] ensembldb_2.11.4            AnnotationFilter_1.11.0    
 [5] GenomicFeatures_1.39.7      AnnotationDbi_1.49.1       
 [7] AnnotationHub_2.19.12       BiocFileCache_1.11.6       
 [9] dbplyr_1.4.3                msigdbr_7.0.1              
[11] scran_1.15.32               SingleCellExperiment_1.9.3 
[13] SummarizedExperiment_1.17.5 DelayedArray_0.13.12       
[15] matrixStats_0.56.0          Biobase_2.47.3             
[17] GenomicRanges_1.39.3        GenomeInfoDb_1.23.17       
...
loaded via a namespace (and not attached):
 ...
 [5] BiocNeighbors_1.5.7           bit64_0.9-7                  
