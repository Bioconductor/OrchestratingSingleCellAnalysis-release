...
```
##  [1] "Top"           "p.value"       "FDR"           "summary.logFC" "logFC.1"       "logFC.2"      
##  [7] "logFC.3"       "logFC.4"       "logFC.5"       "logFC.6"       "logFC.7"       "logFC.8"      
## [13] "logFC.10"      "logFC.11"      "logFC.12"      "logFC.13"      "logFC.14"      "logFC.15"     
## [19] "logFC.16"      "logFC.17"      "logFC.18"
```
...
<div class="figure">
<img src="P2_W07.marker-detection_files/figure-html/heat-basic-pbmc-1.svg" alt="Heatmap of log-fold changes for cluster 9 over all other clusters. Colours are capped at -5 and 5 to preserve dynamic range." width="672" />
...
<div class="figure">
<img src="P2_W07.marker-detection_files/figure-html/heat-focused-pbmc-1.svg" alt="Heatmap of log-fold changes for cluster 9 over all other clusters. Colours are capped at -5 and 5 to preserve dynamic range." width="672" />
...
<div class="figure">
<img src="P2_W07.marker-detection_files/figure-html/heat-wmw-pbmc-1.svg" alt="Heatmap of AUCs for cluster 9 compared to all other clusters." width="672" />
...
<div class="figure">
<img src="P2_W07.marker-detection_files/figure-html/viol-de-binom-1.svg" alt="Distribution of log-normalized expression values for the top 10 DE genes involving cluster 9 with the binomial test, stratified by cluster assignment and coloured by the plate of origin for each cell." width="672" />
...
<div class="figure">
<img src="P2_W07.marker-detection_files/figure-html/viol-gcg-lawlor-1.svg" alt="Distribution of log-normalized expression values for _GCG_ across different pancreatic cell types in the Lawlor pancreas data." width="672" />
...
```
##  [1] "Top"             "p.value"         "FDR"             "summary.logFC"   "logFC.cluster1" 
##  [6] "logFC.cluster2"  "logFC.cluster3"  "logFC.cluster4"  "logFC.cluster5"  "logFC.cluster6" 
## [11] "logFC.cluster7"  "logFC.cluster8"  "logFC.cluster10" "logFC.cluster11" "logFC.cluster12"
## [16] "logFC.cluster13" "logFC.cluster14" "logFC.cluster15" "logFC.cluster16" "logFC.cluster17"
## [21] "logFC.cluster18"
```
...
```
##  [1] "Top"                 "p.value"             "FDR"                 "t.Top"              
##  [5] "wilcox.Top"          "binom.Top"           "t.p.value"           "wilcox.p.value"     
##  [9] "binom.p.value"       "t.FDR"               "wilcox.FDR"          "binom.FDR"          
## [13] "t.summary.logFC"     "wilcox.summary.AUC"  "binom.summary.logFC" "t.logFC.2"          
## [17] "wilcox.AUC.2"        "binom.logFC.2"       "t.logFC.3"           "wilcox.AUC.3"       
## [21] "binom.logFC.3"       "t.logFC.4"           "wilcox.AUC.4"        "binom.logFC.4"      
## [25] "t.logFC.5"           "wilcox.AUC.5"        "binom.logFC.5"       "t.logFC.6"          
## [29] "wilcox.AUC.6"        "binom.logFC.6"       "t.logFC.7"           "wilcox.AUC.7"       
## [33] "binom.logFC.7"       "t.logFC.8"           "wilcox.AUC.8"        "binom.logFC.8"      
## [37] "t.logFC.9"           "wilcox.AUC.9"        "binom.logFC.9"       "t.logFC.10"         
## [41] "wilcox.AUC.10"       "binom.logFC.10"      "t.logFC.11"          "wilcox.AUC.11"      
## [45] "binom.logFC.11"      "t.logFC.12"          "wilcox.AUC.12"       "binom.logFC.12"     
## [49] "t.logFC.13"          "wilcox.AUC.13"       "binom.logFC.13"      "t.logFC.14"         
## [53] "wilcox.AUC.14"       "binom.logFC.14"      "t.logFC.15"          "wilcox.AUC.15"      
## [57] "binom.logFC.15"      "t.logFC.16"          "wilcox.AUC.16"       "binom.logFC.16"     
## [61] "t.logFC.17"          "wilcox.AUC.17"       "binom.logFC.17"      "t.logFC.18"         
## [65] "wilcox.AUC.18"       "binom.logFC.18"
```
...
##             Top     p.value         FDR     t.Top wilcox.Top binom.Top    t.p.value wilcox.p.value
##       <integer>   <numeric>   <numeric> <integer>  <integer> <integer>    <numeric>      <numeric>
## TRAC          1 1.53395e-73 5.38747e-70         1          1         1 2.61642e-307   8.40991e-167
## CD3D          2 1.59894e-73 5.38747e-70         2          2         1 7.26682e-268   1.11253e-156
## CD3E          4 2.06967e-82 9.96220e-79         2          4         2 6.58564e-206   4.10254e-139
## ITGB1         4 4.98826e-47 3.90871e-44         4          4         2  6.91022e-82    1.45852e-68
## ANXA1         5 2.96038e-56 4.33683e-53         2          3         5  8.69304e-99    1.32177e-87
## IL7R          6 3.66173e-84 2.46757e-80         1          6         1 1.44971e-151   4.30298e-119
##       binom.p.value
##           <numeric>
## TRAC    1.53395e-73
## CD3D    1.59894e-73
...
<div class="figure">
<img src="P2_W07.marker-detection_files/figure-html/pval-dist-1.svg" alt="Distribution of $p$-values from a DE analysis between two clusters in a simulation with no true subpopulation structure." width="672" />
...
other attached packages:
 [1] limma_3.43.0                scater_1.15.12              ggplot2_3.2.1              
 [4] pheatmap_1.0.12             scran_1.15.14               SingleCellExperiment_1.9.1 
...
[25] bookdown_0.16            zlibbioc_1.33.0          purrr_0.3.3             
[28] scales_1.1.0             processx_3.4.1           tibble_2.1.3            
[31] farver_2.0.1             withr_2.1.2              lazyeval_0.2.2          
[34] magrittr_1.5             crayon_1.3.4             evaluate_0.14           
[37] ps_1.3.0                 beeswarm_0.2.3           tools_4.0.0             
[40] lifecycle_0.1.0          stringr_1.4.0            munsell_0.5.0           
[43] locfit_1.5-9.1           irlba_2.3.3              callr_3.4.0             
[46] compiler_4.0.0           rsvd_1.0.2               rlang_0.4.2             
[49] grid_4.0.0               RCurl_1.95-4.12          BiocNeighbors_1.5.1     
[52] igraph_1.2.4.2           labeling_0.3             bitops_1.0-6            
[55] rmarkdown_2.0            gtable_0.3.0             R6_2.4.1                
