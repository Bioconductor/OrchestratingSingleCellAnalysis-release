...
## [13] "logFC.11" "logFC.12" "logFC.13" "logFC.14" "logFC.15" "logFC.16"
## [19] "logFC.17" "logFC.18"
```

Of particular interest is the `Top` field, which contains the highest rank for each gene across all pairwise comparisons involving cluster 9.
...
##                 Top              p.value                  FDR
##           <integer>            <numeric>            <numeric>
## TAGLN2            1 4.96068036386322e-20 5.57150547266692e-16
## PF4               1 7.32680851798585e-31 2.46869486205015e-26
## SDPR              2 1.27378543737411e-17 1.07297316317208e-13
## TMSB4X            2 6.87688686215199e-23 1.15854912966674e-18
## PPBP              3 3.12847829237349e-17 2.10821895166465e-13
## NRGN              4 2.87887431982527e-16 1.61667985553654e-12
## GPX1              5 4.19071194112722e-16 2.01716925920486e-12
## GNG11             5 9.80841382733969e-15  4.1310586937298e-11
## CCL5              6 1.71914198062501e-14  6.4360855439088e-11
## HIST1H2AC         7 3.79676561296057e-14 1.27928220563093e-10
```
...
##                        p.value                  FDR
##                      <numeric>            <numeric>
## SDPR      2.89393755520111e-21  9.7508331984946e-17
## PF4       5.79594346408051e-21 9.76442595393642e-17
## PPBP      3.51585963085089e-20 3.94877914672967e-16
## NRGN      9.29995460479362e-20 7.83381676134793e-16
## GNG11      2.8250857832966e-18 1.90376880764791e-14
## HIST1H2AC 1.34166933215319e-17 7.53436774626161e-14
## TUBB1     2.36416578508064e-17  1.1379743137501e-13
## TAGLN2     6.0999991063188e-17 2.56916712360382e-13
## CLU       7.25940078629163e-12 2.71775833437012e-08
## RGS18      1.2272980544931e-10 4.13525806480904e-07
```
...
##                 Top               p.value                   FDR
##           <integer>             <numeric>             <numeric>
## PF4               1 3.13748878071285e-164  1.0571454697734e-159
## TMSB4X            1  5.07214913170393e-27  2.05904810654979e-24
## SDPR              2 2.12114320313369e-145 3.57348995431936e-141
## NRGN              2 1.18239551949308e-131 7.96792692676018e-128
## TAGLN2            3  1.55560414834632e-28  6.98860348991742e-26
## PPBP              3 3.57147966050357e-134 4.01124785603364e-130
## GNG11             3 2.46077445015089e-126 1.38188890538975e-122
## TUBB1             3 7.55572875137595e-133 6.36456811372159e-129
## HIST1H2AC         4   4.6909409429761e-94  1.43687785575123e-90
## ACTB              5  1.53722625960524e-23  5.28523485623867e-21
```
...
## [11] "cluster11" "cluster12" "cluster13" "cluster14" "cluster15"
## [16] "cluster16" "cluster17" "cluster18"
```
...
## [16] "logFC.cluster14" "logFC.cluster15" "logFC.cluster16"
## [19] "logFC.cluster17" "logFC.cluster18"
```
...
##                          Top              p.value                  FDR
##                    <integer>            <numeric>            <numeric>
## Gm6977                     1 7.15186642956623e-24 8.77119955482908e-21
## Myh11                      1 4.56881782028081e-64 2.12925185696366e-59
## Tmsb4x                     2 9.48996559641993e-46 2.21135178327776e-41
## Cd63                       2 1.80445633283328e-15 7.85933485377219e-13
## Cd200r3                    2 2.40861012274322e-45 3.74169553867749e-41
## ...                      ...                  ...                  ...
## Actb                       4 5.61750739782943e-36 2.90887016409382e-32
## Ctsd                       4 2.08646138267597e-42 2.43093615695575e-38
## Fth1                       4 1.83949046845248e-23   2.143190344794e-20
## Ccl9                       5 1.75378024921589e-30 3.71514430611171e-27
## CBFB-MYH11-mcherry         5 9.09026308764551e-39 8.47285241873258e-35
```
...
other attached packages:
 [1] limma_3.41.20                scater_1.13.28              
 [3] ggplot2_3.2.1                pheatmap_1.0.12             
 [5] scran_1.13.32                SingleCellExperiment_1.7.11 
 [7] SummarizedExperiment_1.15.10 DelayedArray_0.11.8         
 [9] BiocParallel_1.19.6          matrixStats_0.55.0          
...
loaded via a namespace (and not attached):
 ...
 [7] statmod_1.4.32           BiocManager_1.30.9      
