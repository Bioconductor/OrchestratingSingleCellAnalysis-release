...
## colnames: NULL
## colData names(2): Barcode cluster
...
## 1.35818791124657e-14

## 4.38558716805188e-17

## 3.04170568092603e-18

## 1.0483429284541e-13

## 1.92631616695152e-11

## 4.90533186350571e-20

## 3.296606994399e-24

## 2.70725398963721e-32

## 4.93706079643116e-32

## 1.89438943741351e-21
...
## 5:2:30:...,7:2:111:...,10:5:136:...,...

## 10:3:117:...,10:4:168:...,10:6:251:...,...

## 6:3:132:...,10:6:181:...,7:3:205:...,...

## 11:8:134:...,8:6:140:...,8:7:157:...,...

## 11:10:153:...,11:7:186:...,11:9:261:...,...

## 9:5:197:...,5:4:219:...,10:5:239:...,...

## 9:5:270:...,7:5:338:...,6:5:366:...,...

## 9:5:300:...,9:6:329:...,5:2:334:...,...

## 7:6:388:...,8:7:403:...,11:8:417:...,...

## 11:4:517:...,5:1:627:...,5:4:634:...,...
```
...
<div class="figure">
<img src="P2_W10.doublet-detection_files/figure-html/markerexprs-1.png" alt="Distribution of log-normalized expression values for _Acta2_ and _Csn2_ in each cluster. Each point represents a cell." width="960" />
...
<div class="figure">
<img src="P2_W10.doublet-detection_files/figure-html/denstsne-1.png" alt="t-SNE plot of the mammary gland data set. Each point is a cell coloured according to its doublet density." width="672" />
...
<div class="figure">
<img src="P2_W10.doublet-detection_files/figure-html/densclust-1.png" alt="Distribution of doublet scores for each cluster in the mammary gland data set. Each point is a cell." width="672" />
...
other attached packages:
 [1] BiocSingular_1.1.5          scater_1.13.17             
 [3] ggplot2_3.2.1               scran_1.13.13              
