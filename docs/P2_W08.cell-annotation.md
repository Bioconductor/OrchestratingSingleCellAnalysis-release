...
<div class="figure">
<img src="P2_W08.cell-annotation_files/figure-html/singler-heat-pbmc-1.svg" alt="Heatmap of the assignment score for each cell (column) and label (row). Scores are shown before any fine-tuning and are normalized to [0, 1] within each cell." width="672" />
...
<div class="figure">
<img src="P2_W08.cell-annotation_files/figure-html/singler-cluster-1.svg" alt="Heatmap of the distribution of cells across labels and clusters in the 10X PBMC dataset. Color scale is reported in the log~10~-number of cells for each cluster-label combination." width="672" />
...
<div class="figure">
<img src="P2_W08.cell-annotation_files/figure-html/aucell-boxplots-1.svg" alt="Distribution of differences between the maximum and median AUCs for each cell, stratified by the assigned label. The red cross indicates the threshold below which outliers are pruned." width="672" />
...
<img src="P2_W08.cell-annotation_files/figure-html/violin-milk-1.svg" width="672" />
...
<div class="figure">
<img src="P2_W08.cell-annotation_files/figure-html/lipid-synth-violin-1.svg" alt="Distribution of average log-normalized expression for genes involved in triacylglycerol biosynthesis, for all cells in each cluster of the mammary gland dataset." width="672" />
...
<div class="figure">
<img src="P2_W08.cell-annotation_files/figure-html/thrsp-violin-1.svg" alt="Distribution of log-normalized expression values for _Thrsp_ across all cells in each cluster of the mammary gland dataset." width="672" />
...
[34] BiocStyle_2.15.3            OSCAUtils_0.0.1            
