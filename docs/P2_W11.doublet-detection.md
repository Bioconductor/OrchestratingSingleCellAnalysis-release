...
<p class="caption">(\#fig:hash-barcode-rank1)Cell-calling statistics from running `emptyDrops()` on the HTO counts in the cell hashing study. Left: Barcode rank plot of the HTO counts in the cell hashing study. Right: distribution of log-total counts for libraries identified as cells.</p>
</div>
...
<div class="figure">
<img src="P2_W11.doublet-detection_files/figure-html/hash-barcode-rank-2.png" alt="Cell-calling statistics from running `emptyDrops()` on the HTO counts in the cell hashing study. Left: Barcode rank plot of the HTO counts in the cell hashing study. Right: distribution of log-total counts for libraries identified as cells." width="672" />
<p class="caption">(\#fig:hash-barcode-rank2)Cell-calling statistics from running `emptyDrops()` on the HTO counts in the cell hashing study. Left: Barcode rank plot of the HTO counts in the cell hashing study. Right: distribution of log-total counts for libraries identified as cells.</p>
</div>
...
## 
##    1    2    3    4    5    6    7    8 
## 2387 2826 2462 2315 2136 2026 2134 2483
```
...
We use outlier detection to explicitly identify putative doublets from those barcode libraries that have an unusually large second-to-third log-fold change.
We visualize this entire process in Figure \@ref(fig:hto-2to3-hash), which shows a clear separation between the putative singlets and doublets.
...
<div class="figure">
<img src="P2_W11.doublet-detection_files/figure-html/hto-2to3-hash-1.png" alt="Log-fold changes between the first, second and third most-abundant HTOs in each cell. Potential doublets are shown in red while confidently assigned singlets are shown in black." width="672" />
<p class="caption">(\#fig:hto-2to3-hash)Log-fold changes between the first, second and third most-abundant HTOs in each cell. Potential doublets are shown in red while confidently assigned singlets are shown in black.</p>
</div>
...
other attached packages:
 [1] DropletUtils_1.7.11         BiocFileCache_1.11.4       
