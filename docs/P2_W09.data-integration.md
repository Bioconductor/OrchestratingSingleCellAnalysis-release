...
processing file: P3_W04.tenx-filtered-pbmc3k-4k-8k.Rmd
...
label: unref-pbmc-filtered-var (with options) 
List of 2
 $ fig.wide: logi TRUE
 $ fig.cap : chr "Percentage of mitochondrial reads in each cell in each of the 10X PBMC datasets, compared to the total count. E"| __truncated__
...
label: unref-filtered-pbmc-variance (with options) 
List of 2
 $ fig.wide: logi TRUE
 $ fig.cap : chr "Per-gene variance as a function of the mean for the log-expression values in each PBMC dataset. Each point repr"| __truncated__
...
label: unref-filtered-pbmc-tsne (with options) 
List of 2
 $ fig.asp: num 1
 $ fig.cap: chr "Obligatory $t$-SNE plots of each PBMC dataset, where each point represents a cell in the corresponding dataset "| __truncated__
...
label: merged-clustering
  |                                                                              |................................................................      |  92%
  ordinary text without R code

  |                                                                              |..................................................................    |  95%
label: unref-filtered-pbmc-merged-tsne (with options) 
List of 2
 $ fig.asp: num 1.2
 $ fig.cap: chr "Obligatory $t$-SNE plots for the merged PBMC datasets, where each point represents a cell and is colored by clu"| __truncated__
...
output file: P3_W04.tenx-filtered-pbmc3k-4k-8k.knit.md

/usr/bin/pandoc +RTS -K512m -RTS P3_W04.tenx-filtered-pbmc3k-4k-8k.utf8.md --to html4 --from markdown+autolink_bare_uris+tex_math_single_backslash --output P3_W04.tenx-filtered-pbmc3k-4k-8k.html --smart --email-obfuscation none --standalone --section-divs --table-of-contents --toc-depth 3 --template /home/luna/Software/R/trunk/library/bookdown/templates/gitbook.html --highlight-style tango --number-sections --css style.css --include-in-header /tmp/Rtmps6G91B/rmarkdown-str12651e2244c3.html --mathjax 

Output created: filtered-human-pbmcs-10x-genomics.html
...
## colnames: NULL
## colData names(13): Sample Barcode ... sizeFactor cluster
...
other attached packages:
 ...
 [3] foreign_0.8-76              maps_3.3.0                 
 [5] sp_1.4-1                    pheatmap_1.0.12            
 [7] scater_1.15.28              ggplot2_3.3.0              
 [9] scran_1.15.22               batchelor_1.3.14           
[11] SingleCellExperiment_1.9.2  SummarizedExperiment_1.17.3
[13] Biobase_2.47.3              GenomicRanges_1.39.2       
[15] GenomeInfoDb_1.23.13        HDF5Array_1.15.13          
[17] rhdf5_2.31.6                DelayedArray_0.13.7        
[19] BiocParallel_1.21.2         IRanges_2.21.5             
[21] S4Vectors_0.25.13           BiocGenerics_0.33.2        
[23] matrixStats_0.56.0          BiocStyle_2.15.6           
[25] OSCAUtils_0.0.2            
...
[16] scales_1.1.0             callr_3.4.2              stringr_1.4.0           
[19] digest_0.6.25            rmarkdown_2.1            XVector_0.27.1          
[22] pkgconfig_2.0.3          htmltools_0.4.0          limma_3.43.5            
[25] highr_0.8                rlang_0.4.5              DelayedMatrixStats_1.9.0
[28] farver_2.0.3             dplyr_0.8.5              RCurl_1.98-1.1          
[31] magrittr_1.5             BiocSingular_1.3.2       GenomeInfoDbData_1.2.2  
[34] Matrix_1.2-18            Rcpp_1.0.4               ggbeeswarm_0.6.0        
[37] munsell_0.5.0            Rhdf5lib_1.9.2           viridis_0.5.1           
[40] lifecycle_0.2.0          stringi_1.4.6            yaml_2.2.1              
[43] edgeR_3.29.1             zlibbioc_1.33.1          Rtsne_0.15              
[46] grid_4.0.0               dqrng_0.2.1              crayon_1.3.4            
[49] lattice_0.20-40          beachmat_2.3.2           cowplot_1.0.0           
[52] locfit_1.5-9.1           knitr_1.28               ps_1.3.2                
[55] pillar_1.4.3             igraph_1.2.5             glue_1.3.2              
[58] evaluate_0.14            BiocManager_1.30.10      gtable_0.3.0            
[61] purrr_0.3.3              assertthat_0.2.1         xfun_0.12               
[64] rsvd_1.0.3               viridisLite_0.3.0        tibble_2.1.3            
[67] beeswarm_0.2.3           statmod_1.4.34          
```
</div>
