...
* For other highly multiplexed protocols, the *[scPipe](https://bioconductor.org/packages/3.10/scPipe)* package provides a more general pipeline for processing scRNA-seq data.
...
other attached packages:
 ...
 [3] ggplot2_3.2.1                scRNAseq_1.99.8             
