...
<div class="figure">
<img src="P3_W06.grun-pancreas_files/figure-html/unref-grun-qc-dist-1.svg" alt="Distribution of each QC metric across cells from each donor of the Grun pancreas dataset. Each point represents a cell and is colored according to whether that cell was discarded." width="672" />
...
<div class="figure">
<img src="P3_W06.grun-pancreas_files/figure-html/unref-grun-norm-1.svg" alt="Relationship between the library size factors and the deconvolution size factors in the Grun pancreas dataset." width="672" />
...
<div class="figure">
<img src="P3_W06.grun-pancreas_files/figure-html/unref-416b-variance-1.svg" alt="Per-gene variance as a function of the mean for the log-expression values in the Grun pancreas dataset. Each point represents a gene (black) with the mean-variance trend (blue) fitted to the spike-in transcripts (red) separately for each donor." width="672" />
...
<div class="figure">
<img src="P3_W06.grun-pancreas_files/figure-html/unref-grun-tsne-1.svg" alt="Obligatory $t$-SNE plots of the Grun pancreas dataset. Each point represents a cell that is colored by cluster (left) or batch (right)." width="672" />
...
[13] tidyselect_0.2.5              gridExtra_2.3                 processx_3.4.1               
