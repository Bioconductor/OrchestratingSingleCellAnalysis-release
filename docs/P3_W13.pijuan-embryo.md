...
<div class="figure">
<img src="P3_W13.pijuan-embryo_files/figure-html/unref-pijuan-var-1.svg" alt="Per-gene variance as a function of the mean for the log-expression values in the Pijuan-Sala chimeric mouse embryo dataset. Each point represents a gene (black) with the mean-variance trend (blue) fitted to the variances." width="672" />
...
<img src="P3_W13.pijuan-embryo_files/figure-html/unref-pijuan-var-2.svg" alt="Per-gene variance as a function of the mean for the log-expression values in the Pijuan-Sala chimeric mouse embryo dataset. Each point represents a gene (black) with the mean-variance trend (blue) fitted to the variances." width="672" />
...
<img src="P3_W13.pijuan-embryo_files/figure-html/unref-pijuan-var-3.svg" alt="Per-gene variance as a function of the mean for the log-expression values in the Pijuan-Sala chimeric mouse embryo dataset. Each point represents a gene (black) with the mean-variance trend (blue) fitted to the variances." width="672" />
...
<div class="figure">
<img src="P3_W13.pijuan-embryo_files/figure-html/unref-nest-tsne-1.svg" alt="Obligatory $t$-SNE plots of the Pijuan-Sala chimeric mouse embryo dataset, where each point represents a cell and is colored according to the assigned cluster (top) or sample of origin (bottom)." width="672" />
