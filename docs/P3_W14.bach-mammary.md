...
<div class="figure">
<img src="P3_W14.bach-mammary_files/figure-html/unref-bach-qc-dist-1.svg" alt="Distribution of each QC metric across cells in the Bach mammary gland dataset. Each point represents a cell and is colored according to whether that cell was discarded." width="672" />
...
<div class="figure">
<img src="P3_W14.bach-mammary_files/figure-html/unref-bach-qc-comp-1.svg" alt="Percentage of mitochondrial reads in each cell in the Bach mammary gland dataset compared to its total count. Each point represents a cell and is colored according to whether that cell was discarded." width="672" />
...
<div class="figure">
<img src="P3_W14.bach-mammary_files/figure-html/unref-bach-norm-1.svg" alt="Relationship between the library size factors and the deconvolution size factors in the Bach mammary gland dataset." width="672" />
...
<div class="figure">
<img src="P3_W14.bach-mammary_files/figure-html/unref-bach-var-1.svg" alt="Per-gene variance as a function of the mean for the log-expression values in the Bach mammary gland dataset. Each point represents a gene (black) with the mean-variance trend (blue) fitted to simulated Poisson counts." width="672" />
...
<div class="figure">
<img src="P3_W14.bach-mammary_files/figure-html/unref-bach-tsne-1.svg" alt="Obligatory $t$-SNE plot of the Bach mammary gland dataset, where each point represents a cell and is colored according to the assigned cluster." width="672" />
