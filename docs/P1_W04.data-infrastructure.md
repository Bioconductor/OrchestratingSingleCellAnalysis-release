...
```
##         cell_1 cell_2 cell_3
## gene_1    4.14   4.45   4.09
## gene_2    4.44   3.90   3.57
## gene_3    4.14   3.76   4.24
## gene_4    3.42   4.54   4.09
## gene_5    4.35   3.43   4.43
## gene_6    3.42   4.15   3.79
## gene_7    4.25   3.43   4.29
## gene_8    4.35   4.45   3.72
## gene_9    4.02   4.26   4.20
## gene_10   4.02   4.03   4.24
```
...
##                             <numeric>    <integer>
## cell_1               1.04139268515822          116
## cell_2               1.04139268515822          115
## cell_3               1.04139268515822          250
```
...
```
##          [,1]      [,2]
## cell_1 -0.510  0.345489
## cell_2  0.685 -0.000299
## cell_3 -0.174 -0.345190
## attr(,"scaled:center")
## [1] -14.5  20.4
```
