...
tmp <- fastMNN(sce, batch = sce$Sample)
...
p2 <- plotReducedDim(sce, use_dimred = 'UMAP_MNN', colour_by = 'Sample')
wrap_plots(p1, p2, nrow = 1)
```
...
p1 <- plotPCA(sce, use_dimred = 'PCA', colour_by = 'Sample')
p2 <- plotReducedDim(sce, use_dimred = 'UMAP_PCA', colour_by = 'Sample')
wrap_plots(p1, p2, nrow = 1)
```
